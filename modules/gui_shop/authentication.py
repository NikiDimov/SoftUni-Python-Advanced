...
from advanced.modules.gui_shop.canvas import tk
from advanced.modules.gui_shop.helpers import clean_screen
from advanced.modules.gui_shop.products import render_products
...
def render_register():
    ...
    Button(tk, text="Register", bg="green", command=lambda: register(username=username.get(),
